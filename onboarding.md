...
**달성됨:**
- 단일 세션 터미널로서 WT/Alacritty 동등 수준의 렌더링 품질
- 한글 IME 완전 해결 (TSF, 94 테스트)
- 고DPI 다중 모니터 대응
...
| Phase | 목표 | 완료 기준 | 상태 |
|-------|------|----------|:----:|
| **Phase 5** | **멀티세션 UI** | 탭 추가/제거/전환, pane 분할, 다중 ConPTY, 설정 패널 | 다음 |
| **Phase 6** | **AI 에이전트 특화** | OSC hooks, 알림 링, 에이전트 배지, Named pipe 서버 | 대기 |
...
*GhostWin Terminal — Onboarding Document v0.4*
*최종 업데이트: 2026-04-01*
