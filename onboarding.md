...
### 확정 실행 순서 (2026-04-15 갱신)

기존 WPF 마일스톤(M-11~M-13)과 Phase 6 의 통합 순서:
...
*GhostWin Terminal — Onboarding Document v0.5*
*최종 업데이트: 2026-04-15 (확정 실행 순서 추가 — M-11 → Phase 6-A → 6-B → (M-12/6-C 병행) → M-13)*
